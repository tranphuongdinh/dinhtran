...
(function (h, f) {
  "function" === typeof define && define.amd ? define([], f) : "object" === (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = f() : h.Rellax = f();
})(void 0, function () {
  var h = function h(f, l) {
    ...
    if (0 < q.length) b.elems = q;else throw Error("The elements you're trying to select don't exist.");
